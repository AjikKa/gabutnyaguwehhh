...
//sound
const openSound = new Audio("soundOpen.mp3");
const closeSound = new Audio("soundClose.mp3");
const sakanigadik = new Audio("sakanigadik.mp3");
const bakso = new Audio("bakso.mp3");
//sakanigadik.play();
//
